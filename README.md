...
| -- | --- | ---- | ----------- |
| EVAROSTIANA | TI.20.A.2 | 312010295| Bahasa Pemrograman |
...
Setelah user memilih data, Misalnya user ingin merubah NIM dari mahasiswa dengan nama evarostiana , Maka akan muncul tampilan seperti ini :
